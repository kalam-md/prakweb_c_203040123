            ...
            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
              ...
              <div>
                ...
                <div class="mt-1 flex items-center">
                  <img src="./img/<?= $b['gambar']; ?>" width="220" style="display: block;" class="img-preview drop-shadow-xl rounded-xl border border-spacing-1 transition ease-in-out delay-150 hover:-translate-y-0.5 hover:scale-110 duration-300">
